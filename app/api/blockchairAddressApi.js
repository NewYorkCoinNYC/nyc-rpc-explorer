...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	...
	return new Promise(function(resolve, reject) {
		var mainnetUrl = `https://api.blockchair.com/newyorkcoin/dashboards/address/${address}/?offset=${offset}`;
		var testnetUrl = `https://api.blockchair.com/newyorkcoin/testnet/dashboards/address/${address}/?offset=${offset}`;
