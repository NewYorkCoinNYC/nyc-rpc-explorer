...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	return new Promise(function(resolve, reject) {
		...
		var mainnetUrl = `https://api.blockcypher.com/v1/nyc/main/addrs/${address}?limit=${limitOffset}`;
		var testnetUrl = `https://api.blockcypher.com/v1/nyc/test3/addrs/${address}?limit=${limitOffset}`;
